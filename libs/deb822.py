...
class _VersionAccessorMixin(object):
    ...
    def get_version(self):
        # type: (_HasVersionFieldProtocol) -> libs.debian_support.Version
        return libs.debian_support.Version(self['Version'])

    def set_version(self, version):
        # type: (_HasVersionFieldProtocol, libs.debian_support.Version) -> None
        ...
        for pkg in self.relations['installed-build-depends']:  # type: ignore
            if pkg[0]['name'] == "base-files":
                ...
                try:
                    ...
                    break
                for rel in libs.debian_support._release_list.values():
...
class Packages(Deb822, _PkgRelationMixin, _VersionAccessorMixin):
    ...
    def source_version(self):
        # type: () -> libs.debian_support.Version
        """ source package that generates the binary package
        ...
        return libs.debian_support.Version(version)
